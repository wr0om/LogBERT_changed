...
def fixed_window(line, window_size, adaptive_window, seq_len=None, min_len=0):
    """Split a session into subsequences with fixed window size"""
...
def generate_train_valid(data_path, window_size=20, adaptive_window=True,
    ...
    """
    Generate train and valid dataset, while each session is split into subsequences with fixed window size"""
